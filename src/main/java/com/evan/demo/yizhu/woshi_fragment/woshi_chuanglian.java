...
public class woshi_chuanglian extends Fragment {
    ...
    public View onCreateView(@Nullable LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        rootView = inflater.inflate(R.layout.fragment_woshi_chuanglian, container, false);
        initUi();
        return rootView;
    }
    ...
    private void initUi() {
        //这里写加载布局的代码
        open = (ImageButton)rootView.findViewById(R.id.woshi_open_chuanglian);
        close = (ImageButton)rootView.findViewById(R.id.woshi_close_chuanglian);
        stop = (ImageButton)rootView.findViewById(R.id.woshi_stop_chuanglian);
    }
