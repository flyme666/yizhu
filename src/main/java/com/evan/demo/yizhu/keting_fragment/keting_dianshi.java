...
public class keting_dianshi extends Fragment {
    ...
    public View onCreateView(@Nullable LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        rootView = inflater.inflate(R.layout.fragment_keting_dianshi, container, false);
        initUi();
        return rootView;
    }
    ...
    private void initUi() {
        //这里写加载布局的代码
        dianshiButton = (ImageButton)rootView.findViewById(R.id.dianshiButton_keting);
    }
