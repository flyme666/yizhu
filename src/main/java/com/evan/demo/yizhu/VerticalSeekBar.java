...
public class VerticalSeekBar extends View {
    ...
    private int startColor= Color.rgb(0,171,121);
    private int middleColor = Color.rgb(255,171,121);
    private int endColor=Color.rgb(114,171,0);
    private int thumbColor=Color.rgb(114,171,121);
    private int thumbBorderColor=Color.rgb(114,171,121);
